...
public class IntroActivity extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		skip.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				releaseMediaPlayer();
				doCleanUp();
				Utilities.startActivityWithAnimation(IntroActivity.this,
                        IntroSubActivity.class);
			}
		});
	}
	...
	public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
		...
		int size = Math.min(getWindowManager().getDefaultDisplay().getWidth(),
				getWindowManager().getDefaultDisplay().getHeight());
		mVideoHeight = mVideoWidth = size;
